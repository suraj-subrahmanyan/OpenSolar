...
-- 1. 文件索引表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_files (
...
-- 2. Agent 索引表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_agents (
...
-- 3. Skill 索引表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_skills (
...
-- 4. 规则索引表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_rules (
...
-- 5. 项目索引表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_projects (
...
-- 6. 关系图谱表
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_relationships (
...
-- 7. 标签系统
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_tags (
...
-- 8. 索引历史表 (记录索引操作)
-- ============================================================
CREATE TABLE IF NOT EXISTS smi_index_history (
...
-- 9. 搜索视图 (统一搜索接口)
-- ============================================================
CREATE VIEW IF NOT EXISTS v_smi_search AS
SELECT
    'file' as entity_type,
    file_id as id,
    title,
...
-- 10. 项目概览视图
-- ============================================================
CREATE VIEW IF NOT EXISTS v_smi_project_overview AS
SELECT
    p.project_id,
    p.name,
    p.status,
...
-- 11. 特性依赖视图
-- ============================================================
CREATE VIEW IF NOT EXISTS v_smi_feature_dependencies AS
SELECT
...
-- 索引优化
-- ============================================================
CREATE INDEX IF NOT EXISTS idx_files_project ON smi_files(project);
CREATE INDEX IF NOT EXISTS idx_files_feature ON smi_files(feature);
CREATE INDEX IF NOT EXISTS idx_files_category ON smi_files(category);
CREATE INDEX IF NOT EXISTS idx_files_modified ON smi_files(last_modified);

CREATE INDEX IF NOT EXISTS idx_relationships_source ON smi_relationships(source_type, source_id);
CREATE INDEX IF NOT EXISTS idx_relationships_target ON smi_relationships(target_type, target_id);
CREATE INDEX IF NOT EXISTS idx_relationships_type ON smi_relationships(relation_type);

CREATE INDEX IF NOT EXISTS idx_tags_entity ON smi_tags(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_tags_tag ON smi_tags(tag);
