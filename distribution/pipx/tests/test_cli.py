...
class OpenSolarCliTests(unittest.TestCase):
    ...
    def test_help_contains_install_commands_examples_and_warnings(self) -> None:
        ...
        self.assertIn("git+https://github.com/suraj-subrahmanyan/OpenSolar.git@v1.0.0-rc.8#subdirectory=distribution/pipx", text)
        self.assertIn("raw.githubusercontent.com/suraj-subrahmanyan/OpenSolar/v1.0.0-rc.8/get-solar.sh", text)
