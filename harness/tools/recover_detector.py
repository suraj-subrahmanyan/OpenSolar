...
DET_PERMISSION = re.compile(
    r"(?i)(Do you want to make this edit|Do you want to overwrite|"
    r"Do you want to allow|allow all edits during this session|deny)"
)
...
class RecoverDetector:
    ...
    def _scan(output: str, pane_id: str, ptype: PromptType,
        ...
        for line in output.splitlines():
            if ptype == PromptType.PERMISSION and "bypass permissions on" in line.lower():
                continue
